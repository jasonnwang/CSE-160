...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let x3 = other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1];
        let y3 = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
        let z3 = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];
    ...
    normalize() {
        ...
        if (mag === 0) {
            return this;  // Return the zero vector unchanged
        }
        this.elements[0] /= mag;
        this.elements[1] /= mag;
        this.elements[2] /= mag;
